...
talleres.forEach((t) =>
  console.log(`- ${t.nombre} (${t.inscritos}/${t.cupo})`),
);
...
console.log(
  "Aplicando la función Find para buscar al instructor 'Ing. María López'",
);
...
console.log(
  "Aplicando Filter + Map encadenados (talleres con cupo disponible)",
);
